...
!function () {
    ...
    function e(e, s) {
        if (e) {
            ...
            e.addEventListener("click", function (t) {
                t.preventDefault();
                var i = e.href.split("#")[1], n = s.element_.querySelector("#" + i);
    ...
    window.componentHandler = function () {
        function e(e, s) {
            for (var t = 0; t < c.length; t++)if (c[t].className === e)return void 0 !== s && (c[t] = s), c[t];
            return !1
        }
        ...
        function i(s, t) {
            if (void 0 === s && void 0 === t)for (var a = 0; a < c.length; a++)i(c[a].className, c[a].cssClass); else {
                var l = s;
                if (void 0 === t) {
                    var o = e(l);
                    o && (t = o.cssClass)
                }
                for (var r = document.querySelectorAll("." + t), _ = 0; _ < r.length; _++)n(r[_], l)
            }
        }
        ...
        function a(e) {
            ...
            for (var s, t = 0, i = e.length; i > t; t++)s = e[t], s instanceof HTMLElement && (s.children.length > 0 && a(s.children), n(s))
        }
        ...
        function l(s) {
            ...
            if (c.forEach(function (e) {
                    if (e.cssClass === t.cssClass)throw new Error("The provided cssClass has already been registered.");
                    if (e.className === t.className)throw new Error("The provided className has already been registered")
                }), s.constructor.prototype.hasOwnProperty(C))throw new Error("MDL component classes must not have " + C + " defined as a property.");
        ...
        function d(e) {
            if (e && e[C].classConstructor.prototype.hasOwnProperty(u)) {
                ...
                var s = p.indexOf(e);
                p.splice(s, 1);
                var t = e.element_.getAttribute("data-upgraded").split(","), i = t.indexOf(e[C].classAsString);
        ...
        function h(e) {
            ...
            if (e instanceof Array || e instanceof NodeList)for (var t = 0; t < e.length; t++)s(e[t]); else {
                if (!(e instanceof Node))throw new Error("Invalid argument provided to downgrade MDL nodes.");
                s(e)
            }
        }

        var c = [], p = [], u = "mdlDowngrade_", C = "mdlComponentConfigInternal_";
        return {
            upgradeDom: i,
            upgradeElement: n,
            upgradeElements: a,
    ...
    if (/iP(ad|hone|od).*OS 6/.test(window.navigator.userAgent) || !window.requestAnimationFrame || !window.cancelAnimationFrame) {
        ...
        window.requestAnimationFrame = function (e) {
            var s = Date.now(), t = Math.max(a + 16, s);
    ...
    window.MaterialMenu = _, _.prototype.Constant_ = {
        ...
        if (this.element_) {
            ...
            var t = this.element_.getAttribute("for"), i = null;
        ...
        if (this.element_ && this.forElement_) {
            var s = this.forElement_.getBoundingClientRect(), t = this.forElement_.parentElement.getBoundingClientRect();
        ...
        if (this.element_ && this.container_) {
            ...
            if (s && s.length > 0 && this.container_.classList.contains(this.CssClasses_.IS_VISIBLE)) {
                ...
                if (e.keyCode === this.Keycodes_.UP_ARROW)e.preventDefault(), t > 0 ? s[t - 1].focus() : s[s.length - 1].focus(); else if (e.keyCode === this.Keycodes_.DOWN_ARROW)e.preventDefault(), s.length > t + 1 ? s[t + 1].focus() : s[0].focus(); else if (e.keyCode === this.Keycodes_.SPACE || e.keyCode === this.Keycodes_.ENTER) {
                    e.preventDefault();
        ...
        if (this.element_ && this.container_ && this.outline_) {
            var s = this.element_.getBoundingClientRect().height, t = this.element_.getBoundingClientRect().width;
        ...
        if (this.element_ && this.container_ && this.outline_) {
            for (var e = this.element_.querySelectorAll("." + this.CssClasses_.ITEM), s = 0; s < e.length; s++)e[s].style.transitionDelay = null;
            var t = this.element_.getBoundingClientRect().height, i = this.element_.getBoundingClientRect().width;
        ...
        for (var e = this.element_.querySelectorAll("." + this.CssClasses_.ITEM), s = 0; s < e.length; s++)e[s].removeEventListener("click", this.boundItemClick), e[s].removeEventListener("keydown", this.boundItemKeydown)
    }, componentHandler.register({constructor: _, classAsString: "MaterialMenu", cssClass: "mdl-js-menu", widget: !0});
    var d = function (e) {
        this.element_ = e, this.init()
    };
    ...
    window.MaterialSpinner = p, p.prototype.Constant_ = {MDL_SPINNER_LAYER_COUNT: 4}, p.prototype.CssClasses_ = {
        ...
        for (var a = [t, i, n], l = 0; l < a.length; l++) {
    ...
    window.MaterialTabs = C, C.prototype.Constant_ = {}, C.prototype.CssClasses_ = {
        ...
        for (var s = 0; s < this.tabs_.length; s++)new e(this.tabs_[s], this);
    ...
    }, componentHandler.register({constructor: C, classAsString: "MaterialTabs", cssClass: "mdl-js-tabs"});
    var m = function (e) {
    ...
    window.MaterialTooltip = E, E.prototype.Constant_ = {}, E.prototype.CssClasses_ = {IS_ACTIVE: "is-active"}, E.prototype.handleMouseEnter_ = function (e) {
        e.stopPropagation();
        var s = e.target.getBoundingClientRect(), t = s.left + s.width / 2, i = -1 * (this.element_.offsetWidth / 2);
    ...
    }, componentHandler.register({constructor: E, classAsString: "MaterialTooltip", cssClass: "mdl-tooltip"});
    var L = function (e) {
        this.element_ = e, this.init()
    };
    window.MaterialLayout = L, L.prototype.Constant_ = {
        ...
        for (var s = 0; s < e.length; s++)e[s].classList.remove(this.CssClasses_.IS_ACTIVE)
        ...
        if (this.element_) {
            ...
            for (var t = this.element_.childNodes, i = 0; i < t.length; i++) {
                var n = t[i];
            ...
            if (this.header_ && this.tabBar_) {
                ...
                for (var m = this.tabBar_.querySelectorAll("." + this.CssClasses_.TAB), E = this.content_.querySelectorAll("." + this.CssClasses_.PANEL), L = 0; L < m.length; L++)new s(m[L], m, E, this)
            }
            this.element_.classList.add(this.CssClasses_.IS_UPGRADED)
        }
    }, componentHandler.register({constructor: L, classAsString: "MaterialLayout", cssClass: "mdl-js-layout"});
    var I = function (e) {
        this.element_ = e, this.init()
    };
    window.MaterialDataTable = I, I.prototype.Constant_ = {}, I.prototype.CssClasses_ = {
        ...
        return s ? function () {
            ...
            var s, i;
            if (e.checked)for (s = 0; s < t.length; s++)i = t[s].querySelector("td").querySelector(".mdl-checkbox"), i.MaterialCheckbox.check(), t[s].classList.add(this.CssClasses_.IS_SELECTED); else for (s = 0; s < t.length; s++)i = t[s].querySelector("td").querySelector(".mdl-checkbox"), i.MaterialCheckbox.uncheck(), t[s].classList.remove(this.CssClasses_.IS_SELECTED)
        }.bind(this) : void 0
        ...
        if (this.element_) {
            var e = this.element_.querySelector("th"), s = this.element_.querySelector("tbody").querySelectorAll("tr");
            if (this.element_.classList.contains(this.CssClasses_.SELECTABLE)) {
                var t = document.createElement("th"), i = this.createCheckbox_(null, s);
                t.appendChild(i), e.parentElement.insertBefore(t, e);
                for (var n = 0; n < s.length; n++) {
                    var a = s[n].querySelector("td");
                    if (a) {
                        var l = document.createElement("td"), o = this.createCheckbox_(s[n]);
    ...
    }, componentHandler.register({constructor: I, classAsString: "MaterialDataTable", cssClass: "mdl-js-data-table"});
    var f = function (e) {
        this.element_ = e, this.init()
    };
        ...
        if (this.element_) {
            ...
            this.element_.classList.contains(this.CssClasses_.RIPPLE_EFFECT_IGNORE_EVENTS) || (this.rippleElement_ = this.element_.querySelector("." + this.CssClasses_.RIPPLE), this.frameCount_ = 0, this.rippleSize_ = 0, this.x_ = 0, this.y_ = 0, this.ignoringMouseDown_ = !1, this.boundDownHandler = this.downHandler_.bind(this), this.element_.addEventListener("mousedown", this.boundDownHandler), this.element_.addEventListener("touchstart", this.boundDownHandler), this.boundUpHandler = this.upHandler_.bind(this), this.element_.addEventListener("mouseup", this.boundUpHandler), this.element_.addEventListener("mouseleave", this.boundUpHandler), this.element_.addEventListener("touchend", this.boundUpHandler), this.element_.addEventListener("blur", this.boundUpHandler), this.getFrameCount = function () {
                ...
                if (null !== this.rippleElement_) {
                    var t, i, n, a = "translate(" + this.x_ + "px, " + this.y_ + "px)";
